...
month[11] = "December";
	...
	$.fn.calendar = function (options) {
		...
		_this.init = function () {
			...
			'<caption>' +
			'	<span class="prev"><a id="event-handler" href="javascript:void(0);">&larr;</a></span>' +
			'	<span class="next"><a id="event-handler"  href="javascript:void(0);">&rarr;</a></span>' +
		...
		_this.delegate('tbody td', 'click', function () {
			/* $( ".select_date" ).toggle( "fast");
			$( ".select_date" ).fadeIn( "fast"); */
			var $this = $(this);
