...
var BackendServices = {
    ...
    updateAvailableCategories: function() {
        var postUrl = GlobalVariables.baseAPIUrl + 'ajax_filter_service_categories';
        var postData = {
...
ServicesHelper.prototype.bindEventHandlers = function() {
    ...
    $('#save-service').click(function() {
        ...
        if(isNaN($('#service-price').val()))
        {
            alert('Please Price* only use number');
            var messageBtns = {};
            messageBtns[EALang['cancel']] = function() {
                $('#message_box').dialog('close');
            };
            GeneralFunctions.displayMessageBox(EALang['service-price-head'],
                EALang['service-price-number'], messageBtns);
        }
...
ServicesHelper.prototype.save = function(service) {
    ...
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_save_service';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
...
ServicesHelper.prototype.delete = function(id) {
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_delete_service';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
        'service_id': id
    };
...
ServicesHelper.prototype.filter = function(key, selectId, display) {
    ...
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_filter_services';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
        'key': key
    };
...
CategoriesHelper.prototype.save = function(category) {
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_save_service_category';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
...
CategoriesHelper.prototype.delete = function(id) {
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_delete_service_category';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
        'category_id': id
    };
