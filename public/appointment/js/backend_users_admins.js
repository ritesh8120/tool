...
AdminsHelper.prototype.save = function(admin) {
    ...
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_save_admin';
    var postData = {
...
AdminsHelper.prototype.delete = function(id) {
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_delete_admin';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
        'admin_id': id
    };
...
AdminsHelper.prototype.filter = function(key, selectId, display) {
    ...
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_filter_admins';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
        'key': key
    };
