...
var FrontendBook = {
    ...
    getAvailableHours: function(selDate) {
        ...
        var postUrl = GlobalVariables.baseUrl + '/member/ajax_get_available_hours';
    ...
    updateConfirmFrame: function() {
        ...
        if (selectedDate !== null) {
            selectedDate = GeneralFunctions.formatDate(selectedDate, 'MDY');
        }
        ...
        var html =
            '<h2>' + $('#select-service option:selected').text() + '</h2>' +
            '<p>'
...
/*
    ...
    */
    ...
    registerAppointment: function() {
        ...
        var postUrl = GlobalVariables.baseUrl + '/member/ajax_register_appointment',
            $layer = $('<div/>');
        ...
        $.ajax({
            ...
            .done(function(response) {
                ...
                window.location.replace(GlobalVariables.baseUrl
                    + '/member/book_success/' + response.appointment_id);
            })
