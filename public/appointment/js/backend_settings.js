...
var BackendSettings = {
    ...
    bindEventHandlers: function() {
        ...
        /*$('#username').focusout(function() {
            ...
            var postUrl = GlobalVariables.baseAPIUrl + 'ajax_validate_username';
            var postData = {
...
SystemSettings.prototype.save = function(settings) {
    var postUrl = GlobalVariables.baseAPIUrl + 'ajax_save_settings';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
        'settings': JSON.stringify(settings),
        'type': BackendSettings.SETTINGS_SYSTEM
    };
    console.log('Save General Settings request:', postData);
    $.post(postUrl, postData, function(response) {
        ///////////////////////////////////////////////////////////
...
UserSettings.prototype.get = function() {
    ...
    // Business Logic Tab
    user._working_plan = JSON.stringify(BackendSettings.wp.get());
